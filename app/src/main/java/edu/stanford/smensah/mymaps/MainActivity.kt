...
const val SWITCH_CLICKED = "SWITCH_CLICKED"
...
class MainActivity : AppCompatActivity() {
    ...
    private var switchToSatellite = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        switchOn = findViewById(R.id.swSatellite)

        switchOn.setOnCheckedChangeListener { _, isChecked ->
            switchToSatellite = isChecked
        }
        ...
        mapAdapter = MapsAdapter(this, userMaps, object: MapsAdapter.OnClickListener {
            override fun onItemCLick(position: Int) {
                ...
                intent.putExtra(SWITCH_CLICKED, switchToSatellite)
